...
//
// The transport comes from the org's `whatsapp_config.provider` via
// providerFromConfig; nothing in this file knows whether the bytes end
// up at the Meta Cloud API or the pilot gateway.
// ------------------------------------------------------------
