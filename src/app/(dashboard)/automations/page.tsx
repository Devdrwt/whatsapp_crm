            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start rounded-xl border border-border bg-card p-4 text-left shadow-card transition-colors hover:border-primary/50 hover:bg-accent"
                >
...
function AutomationCard({
  ...
  return (
    <li className="rounded-xl border border-border bg-card shadow-card transition-colors hover:border-border">
