...
export default function BroadcastsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {broadcasts.length === 0 ? (
        <div className="flex h-64 flex-col items-center justify-center rounded-xl border border-border bg-card shadow-card">
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-border hover:bg-transparent">
                ...
                <TableHead className="hidden text-muted-foreground md:table-cell">{t('headers.template')}</TableHead>
                <TableHead className="hidden text-right text-muted-foreground sm:table-cell">
                  {t('headers.recipients')}
                </TableHead>
                <TableHead className="hidden text-muted-foreground lg:table-cell">{t('headers.delivery')}</TableHead>
                <TableHead className="hidden text-muted-foreground lg:table-cell">{t('headers.read')}</TableHead>
                <TableHead className="text-muted-foreground">{t('headers.status')}</TableHead>
                <TableHead className="hidden text-muted-foreground sm:table-cell">{t('headers.date')}</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
