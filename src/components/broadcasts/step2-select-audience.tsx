...
const OPERATOR_VALUES: CustomFieldOperator[] = ['is', 'is_not', 'contains'];
        ...
        {AUDIENCE_OPTIONS.map((option) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <p className="text-sm font-medium text-foreground">{t(`options.${option.type}.label`)}</p>
            ...
            {tags.map((tag) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium transition-all ${
                    isExcluded
                      ? 'border-red-500/30 bg-red-500/10 text-rose-600 dark:text-rose-300'
                      : 'border-border bg-muted text-foreground hover:border-border'
                  }`}
                >
                  <span
        ...
        {loadingCount ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-foreground">
              {estimatedCount.toLocaleString(locale)}
            </span>
